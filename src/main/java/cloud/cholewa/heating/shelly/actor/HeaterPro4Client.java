...
//    public Mono<ShellyProRelayResponse> controlGarage(final boolean enable) {
//        return webClient.get()
//            .uri(uriBuilder -> uriBuilder.scheme("http").host(SHELLY_PRO4_DOWN_RIGHT)
//                .path("relay/2")
//                .queryParam("turn", enable ? "on" : "off")
...
//    }
    ...
    public Mono<ShellyProRelayResponse> controlPumpFloor(final boolean enable) {
        return webClient.get()
            .uri(uriBuilder -> uriBuilder.scheme("http").host(heaterPro4Config.getSHELLY_PRO4_DOWN_LEFT())
                .path("relay/0")
                .queryParam("turn", enable ? "on" : "off")
                .build())
            .retrieve()
...
//    }
//
//    public Mono<ShellyPro4StatusResponse> getBedroomStatus() {
//        return webClient.get()
//            .uri(uriBuilder -> uriBuilder.scheme("http").host(SHELLY_PRO4_UP_RIGHT)
//                .path("rpc/Switch.GetStatus")
//                .queryParam("id", "0")
...
//            .onStatus(
//                HttpStatusCode::isError, clientResponse -> Mono.error(
//                    new BoilerException("Problem with communication with Shelly Pro4 [UP RIGHT], detail: " + clientResponse.statusCode())
//                )
//            )
//            .bodyToMono(ShellyPro4StatusResponse.class);
//    }
...
//    }
//
//    public Mono<ShellyPro4StatusResponse> getLiviaStatus() {
//        return webClient.get()
//            .uri(uriBuilder -> uriBuilder.scheme("http").host(SHELLY_PRO4_UP_RIGHT)
//                .path("rpc/Switch.GetStatus")
//                .queryParam("id", "1")
...
//    }
//
//    public Mono<ShellyPro4StatusResponse> getTobiStatus() {
//        return webClient.get()
//            .uri(uriBuilder -> uriBuilder.scheme("http").host(SHELLY_PRO4_UP_RIGHT)
//                .path("rpc/Switch.GetStatus")
//                .queryParam("id", "2")
